...
function rpsGame(yourChoice) {
  ...
  botChoice = numberInChoice(randToRpsInt());
...
function numberInChoice(number) {
...
function rpsFrontEnd(humanImageChoice, botImageChoice, finalMessage) {
  ...
  humanDiv.innerHTML = "<img src='" + imagesDatabase[humanImageChoice] + "' height=150 width=150 style='box-shadow:8px 10px 50px rgba(37, 50, 233, 1 )'>"
  messageDiv.innerHTML = "<h1 style='color: " + finalMessage['color'] + "; font-size:35px; padding: 30px; '>" + finalMessage['message'] + "</h1>"
  botDiv.innerHTML = "<img src='" + imagesDatabase[botImageChoice] + "' height=150 width=150 style='box-shadow:8px 10px 50px rgba(243, 38, 24, 1 )'>"
